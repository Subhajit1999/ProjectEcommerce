<?php include('php/auth_server.php') ?>
<!DOCTYPE html>
<html>
            ...
            <div class="col" id="form-area">
                ...
                <div class="form-container">
                    ...
                    <form method="post" id="login-form" action="auth.php">
                        <?php include('php/auth_errors.php'); ?>
                    ...
                    <!-- Registration Form -->
                    <form method="post" id="register-form" action="auth.php">
                        <?php include('php/auth_errors.php'); ?>

                        <h4>Please provide your details to register.</h4>
                        <input type="text" placeholder="Enter Firstname" name="f_name" value="<?php echo $f_name; ?>">
                        <input type="text" placeholder="Enter Lastname" name="l_name" value="<?php echo $l_name; ?>">
